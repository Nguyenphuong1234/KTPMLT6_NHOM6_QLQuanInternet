...
public class KhachHangDao {
    ...
    public List<KhachHang> readListKhachHang() {
        ...
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream("KhachHang.xml");

        try {
            JAXBContext context = JAXBContext.newInstance(KhachHangXML.class);
            Unmarshaller unmarshaller = context.createUnmarshaller();
            KhachHangXML khachHangXML = (KhachHangXML) unmarshaller.unmarshal(inputStream);
